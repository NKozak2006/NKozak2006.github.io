...
function setup() {
    document.getElementById("f1").value = "Garage";
...
var i = 0;
var txt = "Woah! Maybe this next one will be it! You've got a key. Let's check in the bathroom now. Which one though? You'll have to figure that out."; /* The text */
